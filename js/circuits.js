function addCircuitsVTT() {
    for (let i = 0; i < listeCircuitsVttWithCoords.length; i++) {
        addPortion(listeCircuitsVttWithCoords[i].id, "circuit", listeCircuitsVttWithCoords[i].coords, lineWitdhCircuit, lineOpacityCircuit);
    }
}

function addCircuitsMarche() {
    for (let i = 0; i < listeCircuitsMarcheWithCoords.length; i++) {
        addPortion(listeCircuitsMarcheWithCoords[i].id, "circuit", listeCircuitsMarcheWithCoords[i].coords, lineWitdhCircuit, lineOpacityCircuit);
    }
